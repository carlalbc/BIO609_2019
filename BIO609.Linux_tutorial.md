...
![URPP logo](https://pbs.twimg.com/profile_images/1067037157137805313/Yl06jRxY_400x400.jpg =100)
...
cd ..
```
You have succesfully made a new directory and moved in and out of it! :penguin:
*Here we used a **relative path**, we would have gotten the same result with the absolute path:* **mkdir ~/Linux01**

### Now let's make a new file:

```sh
#go to the recently made directory
cd Linux01
#make an empty file
touch emptyfile.txt
# check the empty file by using 
```
